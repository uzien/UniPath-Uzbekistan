...
export default function UniversityCard({ university, studentProfile, onViewDetails }: UniversityCardProps) {
  // Compute dynamic eligibility for this student profile
  const eligibility: EligibilityResult = evaluateEligibility(studentProfile, university);
  ...
  return (
    <div className="relative group p-6 bg-white border border-[#E5E5EA] rounded-[20px] shadow-sm hover:shadow-md hover:border-[#D1D1D6] ios-transition">
        ...
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center gap-1.5 text-xs font-semibold text-[#8E8E93]">
              <span className="uppercase tracking-wider">{university.city}, {university.country}</span>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-y-3 gap-x-4 py-4 border-t border-b border-[#F2F2F7] mb-5 text-[#3A3A3C]">
        <div>
          <span className="block text-[10px] uppercase font-bold text-[#8E8E93] tracking-widest">
            IELTS Requirements
          </span>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="text-xs text-[#8E8E93] line-clamp-1 max-w-[70%]">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-4 py-2 bg-[#007AFF] hover:bg-[#0062CC] text-white rounded-xl text-xs font-bold shadow-sm ios-active-scale ios-transition cursor-pointer ml-auto"
        >
